...
$adminpass                  = (string) getenv('BNT_ADMIN_PASSWORD'); // Optional shared admin/scheduler secret for development and cron access
$admin_mail                 = 'xplosivoctopus@gmail.com';      // The administrator email address
$adminname                  = 'Sythan';                         // The title for the administrator (used when emailing)
