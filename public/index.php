...
if ($server_closed)
{
    echo "<div class='index-welcome' style='color:#ff0; font-size:1.1em; padding-top:2em;'>" . htmlspecialchars($l->get('l_login_closed_message')) . "</div>\n";
    include "footer.php";
    die();
}
?>
...
<div class="index-header">
  <img class="index" src="images/header1.png" alt="Blacknova Traders">
  ...
  <div class="index-lang">
    <select class="lang-select" onchange="location.href=this.value" aria-label="Language">
      <option value="index.php?lang=english"<?php if($lang=='english') echo ' selected'; ?>>English</option>
      <option value="index.php?lang=french"<?php if($lang=='french') echo ' selected'; ?>>Français</option>
      <option value="index.php?lang=german"<?php if($lang=='german') echo ' selected'; ?>>Deutsch</option>
      <option value="index.php?lang=spanish"<?php if($lang=='spanish') echo ' selected'; ?>>Español</option>
    </select>
  </div>
</div>
<br>
...
<br style="clear:both">
<div style="text-align:center">Use the password you chose when creating your account.</div><br>
<div style="text-align:center">
<input class="button green" type="submit" value="<?php echo $l->get('l_login_title'); ?>">
</div>
<div style="text-align:center; margin-top:8px; font-size:.85em;">
<a href="forgot_password.php<?php echo $link; ?>">Forgot your password?</a>
</div>
</form>
<br>
