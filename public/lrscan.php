...
$modal = false;
if (array_key_exists('modal', $_GET) == true && $_GET['modal'] == '1')
{
    $modal = true;
}
...
{
    echo "<div class='scan-modal-content'>\n";
}
...
else
{
    ...
    echo "</td></tr>";
    echo "</table><br>";
    echo "<div class='scan-modal-cta'>";
    echo "  <a class='scan-modal-cta-link' href='move.php?sector=$sector'>";
    echo "    <span class='scan-modal-cta-kicker'>$l_clickme</span>";
    echo "    <span class='scan-modal-cta-main'>$l_lrs_moveto $sector</span>";
    echo "  </a>";
    echo "</div>";
}
