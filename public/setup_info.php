...
foreach ($switch_info as $switch_array)
{
...
foreach ($software_info as $software_array)
{
    $software_key = array_key_first($software_array);
    $software_value = $software_array[$software_key];
...
foreach ($software_versions as $software_array)
{
    $software_key = array_key_first($software_array);
    $software_value = $software_array[$software_key];
    $setup_info->do_Table_Row($software_key,$software_value);
...
$patch_info = is_array($patch_info ?? null) ? $patch_info : array();
